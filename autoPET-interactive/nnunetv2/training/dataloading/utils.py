...
def preprocess_point(point, data_properties, shape):
        ...
        # Subtract the crop origin exactly once, then clamp in cropped space.
        # Applying the crop offset again during the upper-bound clamp shifts
        # inference clicks away from their intended lesion location.
