...
github.com/marchmello1/\allowbreak Tracer-Adaptive-LesionLocator-Ensemble.
...
\section{Conclusion}
Tracer-aware initialization and component-local reconciliation provide one
stateless interactive pipeline for FDG and PSMA PET/CT. The topology ledger
makes the intended correction constraints explicit and independently testable.
...
Training data & Published AutoPET-III and AutoPET-IV training cohorts; no additional local training data \\
...
Architecture and patch & 3-D residual-encoder U-Net; $192\times192\times192$ voxel patches; source batch size 2 \\
Training and augmentation & Public pretrained models; no new optimization or augmentation in this submission \\
Loss and optimizer & Inherited nnU-Net compound Dice/cross-entropy loss; no submission-specific optimizer or schedule \\
Test-time augmentation & None \\
Framework & nnU-Net v2 and PyTorch \\
Pretrained models & Public LesionTracer five-fold ensemble and LesionLocator EDT fold 0 \\
